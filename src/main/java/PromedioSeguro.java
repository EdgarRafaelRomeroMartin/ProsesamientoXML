...
public class PromedioSeguro extends DefaultHandler {
    private static final String CLASS_NAME = PromedioSeguro.class.getName();
    ...
    public void endDocument() throws SAXException {
        ...
        for (Map.Entry<String,Double> entry: entries) {
            System.out.printf("El pomedio de los seguros del modelo %s es %s$\n",entry.getKey(),entry.getValue());
        }
    }
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if ( localName.equals("insurance_record") ) {
            ...
            if ( subtotales.containsKey(this.model) ) {
                ...
                subtotales.put( this.model, (sum+val)/a );
    ...
    public static void main(String args[]) {
        ...
        PromedioSeguro handler = new PromedioSeguro();

...
public class VentasMensuales extends DefaultHandler {
    private static final String CLASS_NAME = VentasMensuales .class.getName();
    ...
    public void endDocument() throws SAXException {
        ...
        for (Map.Entry<String,Double> entry: entries) {
            System.out.printf("El mes de %s tubo un total de ventas de %s$\n",entry.getKey(),entry.getValue());
        }
    }
    ...
    public static void main(String args[]) {
        ...
        VentasMensuales  handler = new VentasMensuales ();
